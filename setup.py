# -*- coding: utf-8 -*-
"""SAMS: Self-adjusted mixture sampling for OpenMM

This module provides an implementation of self-adjusted mixture sampling (SAMS) for OpenMM.
...
setup(name='sams',
      ...
      long_description="\n".join(DOCLINES[2:]),
      version=__version__,
      url='https://github.com/choderalab/sams',
      platforms=['Linux', 'Mac OS-X', 'Unix'],
      classifiers=CLASSIFIERS.splitlines(),
      packages=['sams', 'sams.tests'],
      #package_data={'sams' : find_package_data('examples', 'sams') + find_package_data('sams/data', 'sams')},
      package_data={'sams' : find_package_data('sams/data', 'sams')},
      zip_safe=False,
