...
umbrella_sigma = 0.25 * unit.angstroms # umbrella stddev width in absence of external PMF (no Jacobian)
...
min_distance = 2.0 * unit.angstroms
max_distance = 30.0 * unit.angstroms
...
umbrella_force.addBond(*umbrella_atoms, [])
